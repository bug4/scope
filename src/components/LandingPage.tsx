 ...
 return (
   <div className="min-h-screen bg-white">
     <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 flex gap-4">
       <a 
         href="https://pump.fun/coin/DdPZJgQgKxAjSB7n5BEuRizZBHLfig72Q7EkHwLkpump" 
         target="_blank" 
     ...
     <div className="h-full flex flex-col items-center justify-center px-4 py-16">
       <div className="max-w-4xl w-full text-center mb-16">
         <div className="flex items-center justify-center gap-3 mb-6">
           <h1 className="text-5xl font-bold text-black">SPECO Technologies</h1>
         </div>
